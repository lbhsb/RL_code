...
BATCH_SIZE = 128  # batch size of sampling process from buffer
...
for i_episode in range(3000):
    # play 3000 episodes of cartpole game
    s = env.reset()
    ep_r = 0
    for time_steps in range(500):
        ...
        if dqn.memory_counter > MEMORY_CAPACITY:
            dqn.learn()
            if done:
                print('Ep: ', i_episode, ' |', 'Moving average score: ', ep_r)
        ...
        s = s_
    writer.add_scalar('episode reward', ep_r, global_step=i_episode)
